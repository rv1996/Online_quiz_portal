...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 07, 2015 at 03:54 PM
...
('Javascript', 1002, 'What is the correct JavaScript syntax to change the content of the HTML element below?\n\n<p id="demo">This is a demonstration.</p>'),
...
INSERT INTO `student_info` (`StudentNumber`, `Name`, `B.TechYear`, `Email`, `Password`) VALUES
(1410025, 'Satvik Daga', 2, 'dagasatvik@gmail.com', '@satvikdaga10'),
(1410053, 'Sagarika Vishnoi', 2, 'sagarikavishnoi7@gmail.com', '@sagarikavishnoi7');
...
--
ALTER TABLE `company_info`
  MODIFY `CompanyId` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=1001;
--
